/* En el apartado de ejercicios resueltos se ha presentado un programa para visuali-
 * la representación interna de un float. ¿Se podría resolver este problema utili-
 * zando una función como la siguiente? Razone su respuesta.
 *
...
int main(int argc, char const *argv[])
{
	...
	printf("%d", real.s.b1 ); printf("%d", real.s.b0 );
...
// Respuesta. No se puede ya que los operandos deben ser enteros y c es float.
